...
struct data_link_layer {
	uint8_t frame_tx_nr;       /* next transmit frame number */
	uint8_t frame_tx_ack;      /* last received ack number for transmitted frame */
	uint8_t frame_rx_nr;       /* last received frame number */
};
